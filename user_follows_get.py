...
def _():
    ...
    return dict(users= users, user_email = user_email, error=error, tweet_description=tweet_description,follows=follows, tweet_title=tweet_title, tabs=tabs, reccomendations=reccomendations, trends=trends)
